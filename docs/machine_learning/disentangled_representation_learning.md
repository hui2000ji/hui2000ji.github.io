...
In a follow-up work[^11], the authors propose to progressively increase the bottleneck capacity, so that the encoder can focus on learning one factor of variation at a time and eventually capture more factors of variations than $\beta$-VAE:
...
[^20]: A. Gabbay; Y. Hoshen, [Demystifying Inter-Class Disentanglement](https://iclr.cc/virtua\ell_2020/poster_Hyl9xxHYPr.html), ICLR 2020.
